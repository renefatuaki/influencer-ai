...
1. Twitter Developer Account:
   - Create a new app in your Twitter Developer Portal
   - Configure "User authentication settings":
     - Enable OAuth 1.0a
     - Set App permissions to "Read and write"
     - Select "Web App, Automated App or Bot" as the app type
     - Add "http://127.0.0.1:3000/management" as Callback URI / Redirect URL
   - Save changes and obtain your API keys and access tokens
